...
class WorkoutsAdapter(val context: Context, val callback: WorkoutListener<Workout>) : WorkoutsBaseAdapter<Workout>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): WorkoutsViewHolder = WorkoutsViewHolder(LayoutInflater.from(context).inflate(R.layout.workout_item, parent, false), callback)
