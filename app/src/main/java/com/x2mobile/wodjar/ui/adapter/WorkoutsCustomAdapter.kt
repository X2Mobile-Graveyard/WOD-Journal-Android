...
class WorkoutsCustomAdapter(val context: Context, val callback: WorkoutListener<WorkoutCustom>) : WorkoutsBaseAdapter<WorkoutCustom>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): WorkoutsCustomViewHolder {
        return WorkoutsCustomViewHolder(LayoutInflater.from(context).inflate(R.layout.workout_custom_item, parent, false), callback)
    }
